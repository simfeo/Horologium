...
public class EditCordsOld extends AppCompatActivity implements LocationListener {
...
//		locationManager.requestLocationUpdates(LocationManager.GPS_PROVIDER, 500, 1, this);
		...
		{
			try {
				writingProcedure("Kyiv +2 on north 50 27 00 east 30 30 00");
	...
	public void btClSave () throws IOException
	{
		...
		//    	//���� +2 on north 50 27 00 east 30 30 00
		// city gmt sum/win latit -- -- -- longit -- -- --
